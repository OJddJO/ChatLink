...
class NotificationPopup(ctk.CTkToplevel):
    def __init__(self, parent, text):
        ...
        self.notificationFrame = ctk.CTkFrame(self, bg_color='grey15', width=width-20, height=height-20, corner_radius=10)
        ...
        self.notificationLabel = ctk.CTkLabel(self.notificationFrame, text=text, font=('Arial', 12))
